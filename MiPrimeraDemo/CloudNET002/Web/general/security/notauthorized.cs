...
namespace GeneXus.Programs.general.security {
   public class notauthorized : GXDataArea
   {
      ...
      protected void wb_table1_3_072e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_12_072( true) ;
         }
         else
         {
            wb_table2_12_072( false) ;
         }
         return  ;
      }

      protected void wb_table2_12_072e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_15_072( true) ;
         }
         else
         {
            wb_table3_15_072( false) ;
         }
         return  ;
      }

      protected void wb_table3_15_072e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_15_072( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_15_072e( true) ;
         }
         else
         {
            wb_table3_15_072e( false) ;
         }
      }

      protected void wb_table2_12_072( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_12_072e( true) ;
         }
         else
         {
            wb_table2_12_072e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102819195897", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/security/notauthorized.js", "?2024102819195898", false, true);
