...
namespace GeneXus.Programs.general {
   public class viewtransaction1 : GXDataArea
   {
      ...
      public viewtransaction1( IGxContext context )
      {
      ...
      public void execute( short aP0_InvoiceID ,
                           string aP1_TabCode )
      {
         this.AV12InvoiceID = aP0_InvoiceID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12InvoiceID = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12InvoiceID", StringUtil.LTrimStr( (decimal)(AV12InvoiceID), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vINVOICEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12InvoiceID), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("general.viewtransaction1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12InvoiceID,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"InvoiceID","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vINVOICEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12InvoiceID), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vINVOICEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12InvoiceID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewTransaction1");
         forbiddenHiddens.Add("InvoiceDate", context.localUtil.Format(A7InvoiceDate, "99/99/99"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("general\\viewtransaction1:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("general.viewtransaction1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12InvoiceID,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"InvoiceID","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "General.ViewTransaction1" ;
      }
      ...
      protected void WB080( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Transaction1s", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_General/ViewTransaction1.htm");
            ...
            GxWebStd.gx_label_element( context, edtInvoiceDate_Internalname, "Date", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtInvoiceDate_Internalname, context.localUtil.Format(A7InvoiceDate, "99/99/99"), context.localUtil.Format( A7InvoiceDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtInvoiceDate_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtInvoiceDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_General/ViewTransaction1.htm");
            GxWebStd.gx_bitmap( context, edtInvoiceDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtInvoiceDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_General/ViewTransaction1.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_General/ViewTransaction1.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Product", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_General/ViewTransaction1.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void START082( )
      {
         ...
         Form.Meta.addItem("description", "View Transaction1", 0) ;
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV13Pgmname = "General.ViewTransaction1";
      }
      ...
      protected void RF082( )
      {
         ...
         {
            /* Using cursor H00082 */
            pr_default.execute(0, new Object[] {AV12InvoiceID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A6InvoiceID = H00082_A6InvoiceID[0];
               A7InvoiceDate = H00082_A7InvoiceDate[0];
      ...
      protected void STRUP080( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12InvoiceID = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vINVOICEID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("general\\viewtransaction1:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E11082( )
      {
         ...
         AV14GXLvl7 = 0;
         /* Using cursor H00083 */
         pr_default.execute(1, new Object[] {AV12InvoiceID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A6InvoiceID = H00083_A6InvoiceID[0];
            A7InvoiceDate = H00083_A7InvoiceDate[0];
            AssignAttri("", false, "A7InvoiceDate", context.localUtil.Format(A7InvoiceDate, "99/99/99"));
            AV14GXLvl7 = 1;
            Form.Caption = context.localUtil.DToC( A7InvoiceDate, 1, "/");
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("general.wwtransaction1.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "General.Transaction1General")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "general.transaction1general", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "General.Transaction1General";
               WebComp_Generalwc_Component = "General.Transaction1General";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12InvoiceID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productwc_Component), StringUtil.Lower( "General.Transaction1ProductWC")) != 0 )
            {
               WebComp_Productwc = getWebComponent(GetType(), "GeneXus.Programs", "general.transaction1productwc", new Object[] {context} );
               WebComp_Productwc.ComponentInit();
               WebComp_Productwc.Name = "General.Transaction1ProductWC";
               WebComp_Productwc_Component = "General.Transaction1ProductWC";
            }
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               WebComp_Productwc.setjustcreated();
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12InvoiceID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12InvoiceID = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12InvoiceID", StringUtil.LTrimStr( (decimal)(AV12InvoiceID), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vINVOICEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12InvoiceID), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102819195933", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/viewtransaction1.js", "?2024102819195933", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Transaction1";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12InvoiceID","fld":"vINVOICEID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A7InvoiceDate","fld":"INVOICEDATE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H00082_A6InvoiceID = new short[1] ;
         H00082_A7InvoiceDate = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H00083_A6InvoiceID = new short[1] ;
         H00083_A7InvoiceDate = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.general.viewtransaction1__default(),
            new Object[][] {
                new Object[] {
               H00082_A6InvoiceID, H00082_A7InvoiceDate
               }
               , new Object[] {
               H00083_A6InvoiceID, H00083_A7InvoiceDate
               }
            }
         );
      ...
      private short AV12InvoiceID ;
      private short wcpOAV12InvoiceID ;
      ...
      private short[] H00082_A6InvoiceID ;
      private DateTime[] H00082_A7InvoiceDate ;
      private short[] H00083_A6InvoiceID ;
      private DateTime[] H00083_A7InvoiceDate ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewtransaction1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12InvoiceID",GXType.Int16,4,0)
          };
          Object[] prmH00083;
          ...
          def= new CursorDef[] {
              new CursorDef("H00082", "SELECT [InvoiceID], [InvoiceDate] FROM [Transaction1] WHERE [InvoiceID] = @AV12InvoiceID ORDER BY [InvoiceID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00082,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00083", "SELECT [InvoiceID], [InvoiceDate] FROM [Transaction1] WHERE [InvoiceID] = @AV12InvoiceID ORDER BY [InvoiceID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00083,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
