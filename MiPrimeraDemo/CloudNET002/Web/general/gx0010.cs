...
namespace GeneXus.Programs.general {
   public class gx0010 : GXDataArea
   {
      ...
      public void execute( out short aP0_pInvoiceID )
      {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV6cInvoiceID = (short)(Math.Round(NumberUtil.Val( GetPar( "cInvoiceID"), "."), 18, MidpointRounding.ToEven));
         AV7cInvoiceDate = context.localUtil.ParseDateParm( GetPar( "cInvoiceDate"));
         AV9cCustomerName = GetPar( "cCustomerName");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cInvoiceID, AV7cInvoiceDate, AV9cCustomerName) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("general.gx0010.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10pInvoiceID,4,0))}, new string[] {"pInvoiceID"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCINVOICEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cInvoiceID), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCINVOICEDATE", context.localUtil.Format(AV7cInvoiceDate, "99/99/99"));
         GxWebStd.gx_hidden_field( context, "GXH_vCCUSTOMERNAME", StringUtil.RTrim( AV9cCustomerName));
         /* Send saved values. */
      ...
      {
         return formatLink("general.gx0010.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10pInvoiceID,4,0))}, new string[] {"pInvoiceID"})  ;
      }

      public override string GetPgmname( )
      {
         return "General.Gx0010" ;
      }
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divInvoiceidfiltercontainer_Internalname, 1, 0, "px", 0, "px", divInvoiceidfiltercontainer_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblinvoiceidfilter_Internalname, "Invoice ID", "", "", lblLblinvoiceidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11041_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_General/Gx0010.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCinvoiceid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cInvoiceID), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCinvoiceid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cInvoiceID), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cInvoiceID), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCinvoiceid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCinvoiceid_Visible, edtavCinvoiceid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_General/Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divInvoicedatefiltercontainer_Internalname, 1, 0, "px", 0, "px", "AdvancedContainerItem AdvancedContainerItemExpanded", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblinvoicedatefilter_Internalname, "Invoice Date", "", "", lblLblinvoicedatefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WWAdvancedLabel WWDateFilterLabel", 0, "", 1, 1, 0, 1, "HLP_General/Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcustomernamefilter_Internalname, "Customer Name", "", "", lblLblcustomernamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12041_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_General/Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcustomername_Internalname, StringUtil.RTrim( AV9cCustomerName), StringUtil.RTrim( context.localUtil.Format( AV9cCustomerName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcustomername_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcustomername_Visible, edtavCcustomername_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_General/Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(44), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e13041_client"+"'", TempTags, "", 2, "HLP_General/Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 44 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(44), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_General/Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START042( )
      {
         ...
         Form.Meta.addItem("description", "Selection List Transaction1", 0) ;
         context.wjLoc = "";
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCCUSTOMERNAME"), AV9cCustomerName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF042( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV9cCustomerName = StringUtil.PadR( StringUtil.RTrim( AV9cCustomerName), 20, "%");
            /* Using cursor H00042 */
            pr_default.execute(0, new Object[] {AV6cInvoiceID, AV7cInvoiceDate, lV9cCustomerName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_44_idx = 1;
            sGXsfl_44_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_44_idx), 4, 0), 4, "0");
            SubsflControlProps_442( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A8CustomerID = H00042_A8CustomerID[0];
               A9CustomerName = H00042_A9CustomerName[0];
               A7InvoiceDate = H00042_A7InvoiceDate[0];
               A6InvoiceID = H00042_A6InvoiceID[0];
               A9CustomerName = H00042_A9CustomerName[0];
               /* Execute user event: Load */
               E15042 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_INVOICEID"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(A6InvoiceID), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV9cCustomerName = StringUtil.PadR( StringUtil.RTrim( AV9cCustomerName), 20, "%");
         /* Using cursor H00043 */
         pr_default.execute(1, new Object[] {AV6cInvoiceID, AV7cInvoiceDate, lV9cCustomerName});
      ...
      protected void STRUP040( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCinvoiceid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCinvoiceid_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV6cInvoiceID = 0;
               AssignAttri("", false, "AV6cInvoiceID", StringUtil.LTrimStr( (decimal)(AV6cInvoiceID), 4, 0));
            }
            else
            {
               AV6cInvoiceID = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCinvoiceid_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV6cInvoiceID", StringUtil.LTrimStr( (decimal)(AV6cInvoiceID), 4, 0));
            }
            ...
            AV9cCustomerName = cgiGet( edtavCcustomername_Internalname);
            AssignAttri("", false, "AV9cCustomerName", AV9cCustomerName);
      ...
      protected void E14042( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Selection List %1", "Transaction1", "", "", "", "", "", "", "", "");
      ...
      protected void E16042( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV10pInvoiceID = A6InvoiceID;
         AssignAttri("", false, "AV10pInvoiceID", StringUtil.LTrimStr( (decimal)(AV10pInvoiceID), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV10pInvoiceID});
         context.setWebReturnParmsMetadata(new Object[] {"AV10pInvoiceID"});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102818492161", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/gx0010.js", "?2024102818492161", false, true);
      ...
      protected void SubsflControlProps_442( )
      {
         ...
         edtInvoiceID_Internalname = "INVOICEID_"+sGXsfl_44_idx;
         edtInvoiceDate_Internalname = "INVOICEDATE_"+sGXsfl_44_idx;
         edtCustomerName_Internalname = "CUSTOMERNAME_"+sGXsfl_44_idx;
      }

      protected void SubsflControlProps_fel_442( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_44_fel_idx;
         edtInvoiceID_Internalname = "INVOICEID_"+sGXsfl_44_fel_idx;
         edtInvoiceDate_Internalname = "INVOICEDATE_"+sGXsfl_44_fel_idx;
         edtCustomerName_Internalname = "CUSTOMERNAME_"+sGXsfl_44_fel_idx;
      }
      ...
      protected void sendrow_442( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_44_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A6InvoiceID), 4, 0, ".", "")))+"'"+"]);";
            ...
            edtInvoiceDate_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A6InvoiceID), 4, 0, ".", "")))+"'"+"]);";
            AssignProp("", false, edtInvoiceDate_Internalname, "Link", edtInvoiceDate_Link, !bGXsfl_44_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtInvoiceDate_Internalname,context.localUtil.Format(A7InvoiceDate, "99/99/99"),context.localUtil.Format( A7InvoiceDate, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtInvoiceDate_Link,(string)"",(string)"",(string)"",(string)edtInvoiceDate_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)44,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl44( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A7InvoiceDate, "99/99/99")));
      ...
      public override void initialize_properties( )
      {
         ...
         divInvoiceidfiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
         ...
         Form.Caption = "Selection List Transaction1";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cInvoiceID","fld":"vCINVOICEID","pic":"ZZZ9"},{"av":"AV7cInvoiceDate","fld":"vCINVOICEDATE"},{"av":"AV9cCustomerName","fld":"vCCUSTOMERNAME"}]}""");
         ...
         setEventMetadata("LBLINVOICEIDFILTER.CLICK","""{"handler":"E11041","iparms":[{"av":"divInvoiceidfiltercontainer_Class","ctrl":"INVOICEIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLCUSTOMERNAMEFILTER.CLICK","""{"handler":"E12041","iparms":[{"av":"divCustomernamefiltercontainer_Class","ctrl":"CUSTOMERNAMEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E16042","iparms":[{"av":"A6InvoiceID","fld":"INVOICEID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV10pInvoiceID","fld":"vPINVOICEID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_FIRSTPAGE","""{"handler":"subgrid1_firstpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cInvoiceID","fld":"vCINVOICEID","pic":"ZZZ9"},{"av":"AV7cInvoiceDate","fld":"vCINVOICEDATE"},{"av":"AV9cCustomerName","fld":"vCCUSTOMERNAME"}]}""");
         setEventMetadata("GRID1_PREVPAGE","""{"handler":"subgrid1_previouspage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cInvoiceID","fld":"vCINVOICEID","pic":"ZZZ9"},{"av":"AV7cInvoiceDate","fld":"vCINVOICEDATE"},{"av":"AV9cCustomerName","fld":"vCCUSTOMERNAME"}]}""");
         setEventMetadata("GRID1_NEXTPAGE","""{"handler":"subgrid1_nextpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cInvoiceID","fld":"vCINVOICEID","pic":"ZZZ9"},{"av":"AV7cInvoiceDate","fld":"vCINVOICEDATE"},{"av":"AV9cCustomerName","fld":"vCCUSTOMERNAME"}]}""");
         setEventMetadata("GRID1_LASTPAGE","""{"handler":"subgrid1_lastpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cInvoiceID","fld":"vCINVOICEID","pic":"ZZZ9"},{"av":"AV7cInvoiceDate","fld":"vCINVOICEDATE"},{"av":"AV9cCustomerName","fld":"vCCUSTOMERNAME"}]}""");
         setEventMetadata("VALIDV_CINVOICEDATE","""{"handler":"Validv_Cinvoicedate","iparms":[]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Customername","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         A9CustomerName = "";
         lV9cCustomerName = "";
         H00042_A8CustomerID = new short[1] ;
         H00042_A9CustomerName = new string[] {""} ;
         H00042_A7InvoiceDate = new DateTime[] {DateTime.MinValue} ;
         H00042_A6InvoiceID = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.general.gx0010__default(),
            new Object[][] {
                new Object[] {
               H00042_A8CustomerID, H00042_A9CustomerName, H00042_A7InvoiceDate, H00042_A6InvoiceID
               }
               , new Object[] {
      ...
      private string AV9cCustomerName ;
      ...
      private string lV9cCustomerName ;
      ...
      private short[] H00042_A8CustomerID ;
      private string[] H00042_A9CustomerName ;
      private DateTime[] H00042_A7InvoiceDate ;
      private short[] H00042_A6InvoiceID ;
      private long[] H00043_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP0_pInvoiceID ;
   }
   ...
   public class gx0010__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cInvoiceID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[CustomerID], T2.[CustomerName], T1.[InvoiceDate], T1.[InvoiceID]";
         sFromString = " FROM ([Transaction1] T1 INNER JOIN [Cliente] T2 ON T2.[CustomerID] = T1.[CustomerID])";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[InvoiceID] >= @AV6cInvoiceID)");
         if ( ! (DateTime.MinValue==AV7cInvoiceDate) )
         {
            AddWhere(sWhereString, "(T1.[InvoiceDate] >= @AV7cInvoiceDate)");
         }
         else
         {
            GXv_int1[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9cCustomerName)) )
         {
            AddWhere(sWhereString, "(T2.[CustomerName] like @lV9cCustomerName)");
         }
         else
         {
            GXv_int1[2] = 1;
                                             ...
                                             short AV6cInvoiceID )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Transaction1] T1 INNER JOIN [Cliente] T2 ON T2.[CustomerID] = T1.[CustomerID])";
         AddWhere(sWhereString, "(T1.[InvoiceID] >= @AV6cInvoiceID)");
         if ( ! (DateTime.MinValue==AV7cInvoiceDate) )
         {
            AddWhere(sWhereString, "(T1.[InvoiceDate] >= @AV7cInvoiceDate)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00042(context, (DateTime)dynConstraints[0] , (string)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H00043(context, (DateTime)dynConstraints[0] , (string)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6cInvoiceID",GXType.Int16,4,0) ,
          new ParDef("@AV7cInvoiceDate",GXType.Date,8,0) ,
          new ParDef("@lV9cCustomerName",GXType.NChar,20,0) ,
